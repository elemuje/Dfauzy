...
export default function App() {
  ...
  useEffect(() => {
    const sections = [
      ...
      { id: 'interactive',  ref: interactiveRef },
      { id: 'order',        ref: orderRef },
  ...
  const navItems = [
    ...
    { label: 'Order',       ref: orderRef,      id: 'order' },
    { label: 'Why Us',      ref: whyUsRef,      id: 'why-us' },
    ...
    <div className="min-h-screen bg-near-black text-cream font-body overflow-x-hidden">
      ...
      <nav
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
          isScrolled ? 'bg-near-black/90 backdrop-blur-md shadow-lg py-3' : 'bg-transparent py-5'
        }`}
      >
      ...
      >
        ...
        <div className="relative z-10 text-center px-5 sm:px-8 lg:px-12 max-w-4xl mx-auto pt-16 sm:pt-20">
          ...
          <h1 className="font-display text-3xl sm:text-5xl lg:text-7xl font-bold text-cream mb-4 sm:mb-5 leading-tight animate-fade-in-up">
        ...
        <div className="absolute bottom-5 left-1/2 -translate-x-1/2 animate-float">
          <button onClick={() => scrollTo(aboutRef)} className="text-cream/40 hover:text-gold transition-colors">
      ...
      {/* ══════════════════════════════════════════
          2. ABOUT US
      ══════════════════════════════════════════ */}
      <section ref={aboutRef} id="about" className="relative py-20 sm:py-28 lg:py-32 bg-near-black">
        <div className="w-full px-4 sm:px-6 lg:px-12 xl:px-20">
      ...
      {/* ══════════════════════════════════════════
          3. OUR COLLECTIONS
      ══════════════════════════════════════════ */}
      <section ref={categoriesRef} id="categories" className="relative py-20 sm:py-28 lg:py-32 bg-near-black">
        <div className="w-full px-4 sm:px-6 lg:px-12 xl:px-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {fabricCategories.map((category, index) => (
              ...
              >
                ...
                <a href={WHATSAPP} target="_blank" rel="noopener noreferrer" className="absolute inset-0 z-10" aria-label={`View ${category.name} collection`} />
              </div>
            ))}
          </div>
        </div>
      ...
      {/* ══════════════════════════════════════════
          4. INTERACTIVE — FABRIC FINDER QUIZ
      ══════════════════════════════════════════ */}
      <div ref={interactiveRef} id="interactive">
        <FabricFinderSection whatsapp={WHATSAPP} />
      </div>

      {/* ══════════════════════════════════════════
          5. QUICK ORDER — PLACE AN ENQUIRY
      ══════════════════════════════════════════ */}
      ...
      {/* ══════════════════════════════════════════
          6. WHY US
      ══════════════════════════════════════════ */}
      <section ref={whyUsRef} id="why-us" className="relative py-20 sm:py-28 lg:py-32 bg-near-black">
        <div className="w-full px-4 sm:px-6 lg:px-12 xl:px-20">
          <div className="text-center mb-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
            {whyChooseUs.map((item) => (
              <div key={item.title} className="bg-cream/5 rounded-3xl p-6 text-center card-hover border border-cream/5">
      ...
      {/* ══════════════════════════════════════════
          7. MEET THE CEO
      ══════════════════════════════════════════ */}
      <section ref={ceoRef} id="ceo" className="relative py-20 sm:py-28 lg:py-32 bg-near-black">
        <div className="w-full px-4 sm:px-6 lg:px-12 xl:px-20">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-8 sm:gap-12 items-start sm:items-center">
              ...
              <div className="flex-1 text-center sm:text-left">
                <h3 className="font-display text-2xl sm:text-3xl lg:text-4xl font-bold text-cream mb-2 leading-tight">
                  Alhaja Folake<br />
      ...
      {/* ══════════════════════════════════════════
          9. TESTIMONIALS
      ══════════════════════════════════════════ */}
      <section ref={testimonialsRef} id="testimonials" className="relative py-20 sm:py-28 lg:py-32 bg-near-black">
        <div className="w-full px-4 sm:px-6 lg:px-12 xl:px-20">
          <div className="text-center mb-16">
      ...
      ══════════════════════════════════════════ */}
      <section ref={contactRef} id="contact" className="relative py-20 sm:py-28 lg:py-32 bg-cocoa">
        <div className="w-full px-4 sm:px-6 lg:px-12 xl:px-20">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid sm:grid-cols-3 gap-6 max-w-3xl mx-auto">
              <div className="flex flex-col items-center gap-3">
                ...
                <p className="text-cream/80 text-sm text-center">
                  Opposite Bovas Petrol Station,<br />Lameco, Osogbo, Osun State, Nigeria
                </p>
              </div>
              <div className="flex flex-col items-center gap-3">
                <div className="w-12 h-12 bg-cream/10 rounded-full flex items-center justify-center">
              ...
              <div className="flex flex-col items-center gap-3">
                ...
                <a href="mailto:dfauzyventures@gmail.com" className="text-cream/80 text-sm hover:text-gold transition-colors">
        ...
        <div className="w-full px-4 sm:px-6 lg:px-12 xl:px-20">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-4 gap-10 mb-10">
              ...
              <div>
                ...
                <ul className="space-y-2">
                  {[
                    ...
                    { label: 'Quick Order', ref: orderRef },
                    { label: 'Why Us',      ref: whyUsRef },
                    { label: 'Contact',     ref: contactRef },
                  ].map((item) => (
                    <li key={item.label}>
                      <button onClick={() => scrollTo(item.ref)} className="text-cream/60 hover:text-gold transition-colors text-sm">
                        {item.label}
                      </button>
                    </li>
                  ))}
              ...
              <div>
                ...
                <div className="flex gap-3">
                  <a href={WHATSAPP} target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-gold/20 rounded-full flex items-center justify-center hover:bg-gold/30 transition-colors" aria-label="WhatsApp">
                    <MessageCircle className="w-5 h-5 text-gold" />
                  </a>
                  <a href="https://instagram.com/dfauzyfabrics" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-cream/10 rounded-full flex items-center justify-center hover:bg-cream/20 transition-colors" aria-label="Instagram">
                    <Instagram className="w-5 h-5 text-cream" />
                  </a>
                  <a href="https://www.facebook.com/share/1acNN17A5s/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-cream/10 rounded-full flex items-center justify-center hover:bg-cream/20 transition-colors" aria-label="Facebook">
            ...
            <div className="pt-8 border-t border-cream/5 text-center">
              <p className="text-cream/40 text-sm">© {new Date().getFullYear()} D'fauzy Fabrics. All rights reserved.</p>
            </div>
          </div>
        </div>
      </footer>
...
═══════════════════════════════════════════════════════════ */
const quizSteps = [
  { question: 'What is the occasion?',    options: ['Wedding / Event', 'Everyday Wear', 'Office / Corporate', 'Gift / Business'] },
  { question: 'Who is the fabric for?',   options: ['Women', 'Men', 'Both / Unisex', 'Not sure yet'] },
  { question: 'What feel do you prefer?', options: ['Light & Airy', 'Rich & Structured', 'Soft & Warm', 'Bold & Colourful'] },
];
...
function FabricFinderSection({ whatsapp }) {
  ...
  const choose = (option) => {
    ...
    if (step < quizSteps.length - 1) { setAnswers(next); setStep(step + 1); }
    else { setAnswers(next); setResult(getResult(next)); }
  };
    ...
    <section className="relative py-20 sm:py-28 bg-near-black">
      <div className="w-full px-4 sm:px-6 lg:px-12 xl:px-20">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <h2 className="font-display text-3xl sm:text-4xl font-bold text-cream mb-3">Find Your Perfect Fabric</h2>
          ...
          {!result ? (
            <div className="bg-cream/5 border border-cream/10 rounded-3xl p-6 sm:p-10">
              <div className="flex justify-center gap-2 mb-8">
                {quizSteps.map((_, i) => (
                  <span key={i} className={`w-2 h-2 rounded-full transition-all duration-300 ${i < step ? 'bg-gold' : i === step ? 'bg-gold scale-125' : 'bg-cream/20'}`} />
                ))}
              </div>
              <p className="font-display text-xl sm:text-2xl text-cream mb-6">{quizSteps[step].question}</p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {quizSteps[step].options.map((opt) => (
                  <button key={opt} onClick={() => choose(opt)} className="border border-cream/20 text-cream/80 hover:border-gold hover:text-gold hover:bg-gold/5 px-5 py-4 rounded-2xl text-sm font-medium transition-all text-left btn-press">
                    {opt}
                  </button>
                ))}
              </div>
              {step > 0 && <button onClick={reset} className="mt-6 text-cream/40 hover:text-cream/70 text-xs transition-colors">← Start over</button>}
            </div>
          ) : (
            <div className="bg-cream/5 border border-gold/30 rounded-3xl p-6 sm:p-10 animate-fade-in">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
                <a href={waLink} target="_blank" rel="noopener noreferrer" className="bg-gold text-near-black px-7 py-3 rounded-full text-sm font-semibold hover:bg-gold-light transition-all btn-press flex items-center gap-2">
                  <MessageCircle className="w-4 h-4" />
                  Order {result.fabric}
                </a>
                <button onClick={reset} className="border border-cream/30 text-cream/70 px-7 py-3 rounded-full text-sm font-medium hover:bg-cream/10 transition-all btn-press">
                  Try again
                </button>
              </div>
            </div>
...
function OrderFormSection({ whatsapp }) {
  ...
  const fabricOptions = ['Lace', 'Swiss Voile', 'Ankara', 'Cashmere', 'Damask', 'Senator Materials', 'Adire', 'Kampala', 'Other'];
      ...
      <div className="w-full px-4 sm:px-6 lg:px-12 xl:px-20">
        <div className="max-w-xl mx-auto">
          <div className="text-center mb-10">
            ...
            <h2 className="font-display text-3xl sm:text-4xl font-bold text-cream mb-3">Place an Enquiry</h2>
          ...
          <div className="bg-cream/5 border border-cream/10 rounded-3xl p-6 sm:p-8 space-y-4">
            <div>
              ...
              <input type="text" name="name" value={form.name} onChange={change} placeholder="e.g. Mrs. Adaeze"
            ...
            <div>
              ...
              <select name="fabric" value={form.fabric} onChange={change}
            ...
            <div>
              ...
              <input type="text" name="qty" value={form.qty} onChange={change} placeholder="e.g. 6 yards, 2 pieces"
                className="w-full bg-near-black border border-cream/15 hover:border-cream/30 focus:border-gold focus:outline-none rounded-xl px-4 py-3 text-cream placeholder:text-cream/30 text-sm transition-colors" />
            </div>
            <div>
              <label className="block text-cream/60 text-xs tracking-widest uppercase mb-1.5">Additional Notes</label>
              <textarea name="notes" value={form.notes} onChange={change} rows={3} placeholder="Colour preference, occasion, budget…"
            ...
            <p className="text-center text-cream/30 text-xs">This opens WhatsApp with your details pre-filled — no data is stored.</p>
          </div>
        </div>
      </div>
    </section>
